...
function getAddressBalance(addressHash, currency) {
    var currency = currency || 'USD';
    var that = this;

    return q.all([getAddressBitcoinBalance(addressHash), this.getCurrentPrice(currency)])
...
function getTransactionPrice(trxID, currency) {
    var currency = currency || 'USD';
