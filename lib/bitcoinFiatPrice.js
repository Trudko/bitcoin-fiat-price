...
module.exports = {
    getAddressFiatBalance: getAddressFiatBalance,
    getCurrentFiatPrice: getCurrentFiatPrice,
    getTransactionFiatPrice: getTransactionFiatPrice
}

function getAddressFiatBalance(addressHash, currency) {
...
function getCurrentFiatPrice(currency) {
    var currency = currency || 'USD',
...
function getTransactionFiatPrice(trxID, currency) {
    var currency = currency || 'USD';
...
function getTransactionFiatValue(transactionInfo, currency) {
